    ...
    <div class="x-panel-body">
        ...
        <table id="x-data-list-table">
            <tr class="x-tr1">
                ...
                <th class="x-th" style="width:100px;">價格</th>
                <th class="x-th">名稱</th>
                <th class="x-th">說明</th>
                <!--@stand_th-->
            ...
            for ($i=1; $i <= $pagetool->rrows; $i++){
                ...
                $item['dist'] = $xmlvo->value('/content/dist');
                $item['tel'] = $xmlvo->value('/content/tel');
                $item['addr'] = $xmlvo->value('/content/addr');
            ?>
