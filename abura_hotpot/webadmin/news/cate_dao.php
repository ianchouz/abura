...
class category extends controller {
    ...
    function __construct() {
        ...
        $this->cfg = $CFG->newscate; // 上傳路徑/編輯器路徑

        ##資料欄位名稱=預設值,欄位性質(int/bool;editor/editor_simple/textarea,空白表純文字)
        $this->_cols['id'] = array('d4'=> null, 'type'=>'int');
        $this->_cols['seq'] = array('d4'=> $this->getMexSeq(), 'type'=>'');
        $this->_cols['pid'] = array('d4'=> -1, 'type'=>'int');
        $this->_cols['leaf'] = array('d4'=> $leaf_default, 'type'=>'bool');

        $this->_cols['summary'] = array('d4'=> null, 'type'=>'editor_simple');
