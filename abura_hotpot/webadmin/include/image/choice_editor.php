...
<script type="text/javascript" charset="utf-8" src="<?=$CFG->f_admin?>include/jqueryFileTree/jqueryFileTree2.js?v=3"></script>
    ...
    <tr>
      ...
      <td width="80%" valign="top">
        <div style="background:#F1EFE2;border:1px solid #D4D0C8;padding:5px;">
          <input type="button" value="選擇" id="btn_choiceIMG"> <input type="button" value="刪除選取檔案" id="btn_clickdeleteimg"> <input type="button" value="刪除目錄" id="btn_clickdeletedir"> <input type="button" value="建立新目錄" id="btn_clickcreatedir"> <input type="button" value="上傳圖片" id="btn_clickUpload">
        </div>
