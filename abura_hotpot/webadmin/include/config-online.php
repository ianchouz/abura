...
$CFG->dbname = 'abura_hotpot';//資料庫名稱
$CFG->dbuser = 'abura_hotpot';//資料庫帳號
$CFG->dbpass = 'xgY&m197';//資料庫密碼
//==========================================
//網站檔案資料夾名稱
$CFG->doc_web = '';//以IP瀏覽的時候帶的資料夾目錄
$CFG->real_domain = 'abura.com.tw';//真實域名，不帶有 http 喔!!
$CFG->full_domain = 'https://www.abura.com.tw/abura_hotpot/'; //程式用的網站路徑，包含完成的http及域名或IP+目錄
$CFG->base_domain = 'https://www.abura.com.tw/abura_hotpot/';//用在後台登入預設語言位置60.249.71.45/
//==========================================
//後台語言版本設定
//==========================================
$langs = array();
